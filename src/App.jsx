  ...
  rounds: [
    ...
    },
    {
      ...
      categories: [
        ...
        category("Огненная тема", [
          question(200, "Вопрос будет добавлен позже.", "Будет добавлено позже", { image: "src/question-media/round2/fire/200.png" }),
          question(400, "Вопрос будет добавлен позже.", "Будет добавлено позже", { image: "src/question-media/round2/fire/400.png" }),
          question(600, "Вопрос будет добавлен позже.", "Будет добавлено позже", { image: "src/question-media/round2/fire/600.png" }),
          question(800, "Вопрос будет добавлен позже.", "Будет добавлено позже", { image: "src/question-media/round2/fire/800.png" }),
          question(1000, "Вопрос будет добавлен позже.", "Будет добавлено позже", { image: "src/question-media/round2/fire/1000.png" }),
        ]),
      ],
    },
    {
      ...
      categories: [
        category("Жуков", [
          question(300, "Посмотрите видео и дайте ответ.", "Путали с флагом Боливии, когда вывешивали на международных мероприятиях.", { video: "src/question-media/round3/zhukov/01.mp4" }),
        ...
        category("Правая тема", [
          question(300, "Вопрос будет добавлен позже.", "Будет добавлено позже"),
          question(600, "Вопрос будет добавлен позже.", "Будет добавлено позже"),
          question(900, "Вопрос будет добавлен позже.", "Будет добавлено позже"),
          question(1200, "Вопрос будет добавлен позже.", "Будет добавлено позже"),
          question(1500, "Вопрос будет добавлен позже.", "Будет добавлено позже"),
        ]),
